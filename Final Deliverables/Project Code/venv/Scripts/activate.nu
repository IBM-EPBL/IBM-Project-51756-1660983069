...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Ishwarya Sriram\Projects\Flask\IBM\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Ishwarya Sriram\Projects\Flask\IBM\venv\Scripts\deactivate.nu'
